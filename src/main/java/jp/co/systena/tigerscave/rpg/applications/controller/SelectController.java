...
//      List<String> jobList = new ArrayList<String>();
      Character.setJobNameList(jobForm.getJobNameList());
      Character.setCharaNameList(jobForm.getCharaNameList());
    ...
    int insertCount = jdbcTemplate.update(
        ...
        Character.getNameList(),
        Character.getAttackWayList(),
        Character.getJobList());
    return mav;
  }
